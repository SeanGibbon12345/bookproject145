   ...
   public static void getBooks(BookCollection collection, String fileName){
      ...
      while (input.hasNextLine()) {
         ...
         try {
            ...
            String author = lineData.next();
            String publisher = lineData.next();
            int year = lineData.nextInt();
            int edition = lineData.nextInt();
            String isbn = lineData.next();
            double price = lineData.nextDouble();
            String format = lineData.next();
            Book book = new Book(title, author, publisher, year, edition, isbn, price, format);
            try {
